...
class ichiV1(IStrategy):
    ...
    buy_trend_above_senkou_level_short = IntParameter(1,8, default=5, space="buy")
    buy_trend_bullish_level_short = IntParameter(1,8, default=6, space="buy")
    buy_fan_magnitude_shift_value_short = IntParameter(1,8, default=5, space="buy")
    buy_min_fan_magnitude_gain_short = DecimalParameter(0.980, 1.020, default=1.002, space="buy")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Trends magnitude
        conditions_long.append(dataframe['fan_magnitude_gain'] >= self.buy_min_fan_magnitude_gain.value)
...
############################################### SHORT CONDITION ###########################################################
        ...
        if self.buy_trend_above_senkou_level_short.value <= 1:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 2:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 3:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 4:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 5:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 6:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 7:
        ...
        if self.buy_trend_above_senkou_level_short.value <= 8:
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions_long.append(qtpylib.crossed_below(dataframe['trend_close_5m'], dataframe[self.sell_trend_indicator.value]))
        ...
        conditions_short.append(qtpylib.crossed_above(dataframe['trend_close_5m'], dataframe[self.sell_trend_indicator.value]))
